...
local DinoWindow = Dino:CreateWindow("Anime Story")
...
stat:CreateToggle("Energy",function(value)
_G.Energy = value
while _G.Energy do wait(0.1)
local args = {
    [1] = "Energy",
    [2] = 1
}
...
stat:CreateToggle("Strength",function(value)
_G.Strength = value
while _G.Strength do wait(0.1)
local args = {
    [1] = "Strength",
    [2] = 1
}
...
stat:CreateToggle("Magic",function(value)
_G.Magic = value
while _G.Magic do wait(0.1)
local args = {
    [1] = "Magic",
    [2] = 1
}
...
stat:CreateToggle("Speed",function(value)
_G.Speed = value
while _G.Speed do wait(0.1)
local args = {
    [1] = "Speed",
    [2] = 1
}
